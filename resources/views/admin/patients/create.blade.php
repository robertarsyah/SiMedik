            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form method="POST" action="{{ route('admin.patients.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block font-bold text-sm text-gray-700">NIK (16 Digit)</label>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-pink-500 focus:ring-pink-500" required>{{ old('address') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-3 mt-8">
                        ...
                        <button type="submit"
                            class="px-4 py-2 bg-pink-600 text-white rounded-md hover:bg-pink-700 shadow-sm transition font-bold">Daftarkan
                            Pasien</button>
                    </div>
                </form>
            </div>
